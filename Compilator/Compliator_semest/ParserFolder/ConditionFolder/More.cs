...
{
    public class More : BinaryCondition
    {
        public More(Expression left, Expression right) : base(left, right)
        {
        }
        ...
        public override bool Evaluate(ExecutionContext context)
        {
            ...
            throw new Exception("More: invalid data on right or left side");
        }
    }
}
