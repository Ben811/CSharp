...
{
    public class MoreEqual : BinaryCondition
    {
        public MoreEqual(Expression left, Expression right) : base(left, right)
        {
        }
        ...
        public override bool Evaluate(ExecutionContext context)
        {
            ...
            throw new Exception("MoreEqual: invalid data on right or left side");
        }
    }
}
